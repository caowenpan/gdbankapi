...
@XmlType(name = "ZSEAICOMMON", namespace = "urn:iwaysoftware:ibse:jul2003:O_Z_EAI_IMP_CCCMA_GD:response", propOrder = {
    "callbackid",
    "infocode",
    "message",
    "timebegin",
...
public class ZSEAICOMMON2 {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ZSEAICOMMON2{");
